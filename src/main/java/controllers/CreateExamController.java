...
public class CreateExamController {
    ...
    private void showExamCodeDialog(Exam exam) {
        ...
        Label titleLabel = new Label("Code d'Examen:");
        ...
        Label instructionLabel = new Label("Partagez ce code avec vos étudiants pour qu'ils puissent rejoindre l'examen.");
        ...
        content.getChildren().addAll(titleLabel, codeField, copyButton, instructionLabel, examInfoLabel);
